...
def customer(cu1):
    ...
    load = Image.open(r"logo3.jpg")
    photo = ImageTk.PhotoImage(load)
    img = Label(window2, image=photo)
    img.image = photo
    img.place(x=320, y=0, height=146)

    frame = Frame(window2, bg='white')
    frame.place(relx=0.1, rely=0, relwidth=0.20, relheight=0.2077)
    frame2 = Frame(window2, bg='white')
    frame2.place(relx=0.750, rely=0, relwidth=0.150, relheight=0.2077)
